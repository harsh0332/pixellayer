        ...
        {data.map((it, i) => (
          <article key={i} ref={(el) => { cardEls.current[i] = el; }} style={{
            ...
            <div style={{ padding: "18px 20px", display: "grid", gap: 9 }}>
              ...
              <div style={{ fontFamily: mono, fontSize: 10.5, letterSpacing: "0.14em", color: "#7A808C", marginTop: 6 }}>VIEW CASE →</div>
            </div>
          </article>
        ))}
...
if (typeof module !== "undefined" && module.exports) module.exports = { ScrollFanPortfolio, default: ScrollFanPortfolio };
if (typeof window !== "undefined") window.ScrollFanPortfolio = ScrollFanPortfolio;
