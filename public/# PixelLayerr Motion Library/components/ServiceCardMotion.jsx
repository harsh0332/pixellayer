...
if (typeof module !== "undefined") module.exports = { ServiceCardMotion };
// Next.js: replace the line above with:  export { ServiceCardMotion }; export default ServiceCardMotion;
