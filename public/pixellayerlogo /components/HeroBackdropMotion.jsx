...
if (typeof module !== "undefined") module.exports = { HeroBackdropMotion };
// Next.js: replace the line above with:  export { HeroBackdropMotion }; export default HeroBackdropMotion;
