...
if (typeof module !== "undefined") module.exports = { LogoMarqueeMotion };
// Next.js: replace the line above with:  export { LogoMarqueeMotion }; export default LogoMarqueeMotion;
