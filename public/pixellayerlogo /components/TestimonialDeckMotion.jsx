...
if (typeof module !== "undefined") module.exports = { TestimonialDeckMotion };
// Next.js: replace the line above with:  export { TestimonialDeckMotion }; export default TestimonialDeckMotion;
