...
if (typeof module !== "undefined") module.exports = { StatCounterMotion };
// Next.js: replace the line above with:  export { StatCounterMotion }; export default StatCounterMotion;
