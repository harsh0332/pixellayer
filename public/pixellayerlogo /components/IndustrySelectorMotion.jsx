...
if (typeof module !== "undefined") module.exports = { IndustrySelectorMotion };
// Next.js: replace the line above with:  export { IndustrySelectorMotion }; export default IndustrySelectorMotion;
