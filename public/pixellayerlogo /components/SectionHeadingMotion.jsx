...
if (typeof module !== "undefined") module.exports = { SectionHeadingMotion };
// Next.js: replace the line above with:  export { SectionHeadingMotion }; export default SectionHeadingMotion;
